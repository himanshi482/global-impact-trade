...
export function calculateOpportunityScore({
  ...
  return {
    ...
    tier,
    factors: [
      { name: "Buyer Demand", contribution: buyerDemand, reason: `Based on ${buyerCount} matching buyer entities.` },
      { name: "Shipment Activity", contribution: shipmentActivity, reason: `Based on ${shipmentCount} recorded shipments and ${totalShipmentValue} total trade value.` },
      { name: "Buyer Availability", contribution: buyerAvailability, reason: `Based on ${verifiedBuyerCount} verified buyers out of ${buyerCount}.` },
      { name: "Supplier Competition", contribution: supplierCompetition, reason: `Based on ${supplierCount} matching supplier entities.` },
    ],
    breakdown: {
      buyerDemand,
      shipmentActivity,
